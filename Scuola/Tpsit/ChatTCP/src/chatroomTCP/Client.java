    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            while (!access)
            {
                ...
                if (serverAnswer.compareToIgnoreCase("access granted") == 0)
                {
                    access = true;
                    System.out.println("access executed");
                } else if (serverAnswer.compareToIgnoreCase("access denied") == 0)
                {
                    System.out.println("Wrong credentials");
                    command="";
                } else if (serverAnswer.compareToIgnoreCase("account created") == 0)
                {
                    access = true;
                    System.out.println("the account was created successfully");
                } else if (serverAnswer.compareToIgnoreCase("account already exist") == 0)
                {
            ...
            System.out.println("Ti sei connesso alla chat");
